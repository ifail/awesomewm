...
local function create_calendar()
   ...
   local first_day_in_week =
      os.date("%w", first_day)
   local result = "do seg ter qua qui sab\n"
...
vicious.register(weatherwidget, vicious.widgets.weather,
    function (widget, args)
        if args["{tempf}"] == "N/A" then
            ...
            elseif( args["{sky}"] == "Clear" ) then args["{sky}"] = "☼"
            elseif( args["{sky}"] == "Cloudy" ) then args["{sky}"] = "☃"
            elseif( args["{sky}"] == "Mostly Cloudy" ) then args["{sky}"] = "☂"
            end
...
globalkeys = awful.util.table.join(
    ...
    -- User programs
    awful.key({ "Control",        }, "b",      function () awful.util.spawn( "chromium", false ) end),
    awful.key({ "Control",        }, "i",      function () awful.util.spawn( "midori", false ) end),
    awful.key({ "Control",        }, "e",      function () awful.util.spawn(gui_editor) end),
    awful.key({ "Control", 	     }, "t", 	    function () awful.util.spawn( "thunderbird", false ) end),
    awful.key({ "Control",        }, "f", 	    function () awful.util.spawn( "thunar", false ) end),
